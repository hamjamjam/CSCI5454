...
function [tstim, firstorsecond, cor, lapses] = pest_mod_2int(trial_no, mu_air, sigma_air, guess_rate, lapse_rate, plot_on, initial_stim)
...
% mu_air=0;                   	% mean of psychometric ft.
% sigma_air=1;                    % S.D of psychometric ft.
% lambda_init=0;
% lapse_rate = 0.05;

% initial_stim=4;
% initial_stim=initial_stim*sigma_air;
...
%     fit_glm(2,sim_cnt)=1/b(2);          % sigma
    ...
    if plot_on
        ...
        xlabel('Trial Number');
        ylabel('Simulus Intensity (e.g., tactile vibration magnitude)');
